  ...
  <body>
    ...
    <div class="body">
      ...
      <g:form method="post" onsubmit="\$('[placeholder]').placeholder('clear');" >
        ...
        <div class="dialog">
          <p>
            <label for="descricao"><g:message code="categoria.descricao.label" default="Descrição" /></label>
            <g:textField name="descricao" maxlength="64" value="${categoriaInstance?.descricao}" class="value ${hasErrors(bean: categoriaInstance, field: 'descricao', 'errors')}" placeholder="descrição" />
          </p>
        </div>
        <div class="buttons">
