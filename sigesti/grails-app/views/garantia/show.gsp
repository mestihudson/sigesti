		...
		<div class="body">
			...
			<div class="dialog">
				<table id="myTable" class="tableview">
					<tbody>
						<tr class="prop odd">
							<td class="name"><g:message code="garantia.id.label" default="Id" /></td>
							<td class="value">${fieldValue(bean: garantiaInstance, field: "id")}</td>
						</tr>
						<tr class="prop even">
							<td class="name"><g:message code="garantia.descricao.label" default="Descrição" /></td>
							<td class="value">${fieldValue(bean: garantiaInstance, field: "descricao")}</td>
						</tr>
						<tr class="prop odd">
							<td class="name"><g:message code="garantia.detalhes.label" default="Detalhes" /></td>
							<td class="value">${fieldValue(bean: garantiaInstance, field: "detalhes")}</td>
						</tr>
					</tbody>
				</table>
			</div>
