		...
		<div class="body">
			...
			<div class="dialog">
				<table id="myTable" class="tableview">
					<tbody>
						<tr class="prop odd">
							<td class="name"><g:message code="areaResponsavel.id.label" default="Id" /></td>
					<td class="value">${fieldValue(bean: areaResponsavelInstance, field: "id")}</td>
					</tr>
					<tr class="prop even">
						<td class="name"><g:message code="areaResponsavel.descricao.label" default="Descrição" /></td>
					<td class="value">${fieldValue(bean: areaResponsavelInstance, field: "descricao")}</td>
					</tr>
					</tbody>
				</table>
			</div>
