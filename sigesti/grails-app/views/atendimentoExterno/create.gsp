			...
			<g:form action="save" onsubmit="\$('[placeholder]').placeholder('clear');" >
				<div class="dialog">
					<p>
						...
						<g:select name="garantia.id" noSelection="['null': '--Selecione--']" class="value ${hasErrors(bean: atendimentoExternoInstance, field: 'garantia', 'errors')}" from="${sigesti.Garantia.list()}" optionKey="id" value="${atendimentoExternoInstance?.garantia?.id}" />
					</p>
				</div>
				<div class="buttons">
