    ...
    <div class="body">
      ...
      <div class="dialog">
        <table id="myTable" class="tableview">
          <tbody>
            <tr class="prop odd">
              <td class="name"><g:message code="solucao.id.label" default="Id" /></td>
              <td class="value">${fieldValue(bean: solucaoInstance, field: "id")}</td>
            </tr>
            <tr class="prop even">
              <td class="name"><g:message code="solucao.solucao.label" default="Solução" /></td>
              <td class="value">${fieldValue(bean: solucaoInstance, field: "solucao")}</td>
            </tr>
          </tbody>
        </table>
      </div>
