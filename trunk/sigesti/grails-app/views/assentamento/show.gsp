			...
			<div class="dialog">
				<table id="myTable" class="tableview">
					<tbody>
						...
						<tr class="prop odd">
							<td class="name"><g:message code="assentamento.id.label" default="Id" /></td>
							<td class="value">${fieldValue(bean: assentamentoInstance, field: "id")}</td>
						</tr>

						<tr class="prop even">
							<td class="name"><g:message code="assentamento.chamado.label" default="Chamado" /></td>
							<td class="value"><g:link controller="chamado" action="show" id="${assentamentoInstance?.chamado?.id}">${assentamentoInstance?.chamado?.encodeAsHTML()}</g:link></td>
						</tr>

						<tr class="prop odd">
							<td class="name"><g:message code="assentamento.descricao.label" default="Descrição" /></td>
							<td class="value">${fieldValue(bean: assentamentoInstance, field: "descricao")}</td>
						</tr>
