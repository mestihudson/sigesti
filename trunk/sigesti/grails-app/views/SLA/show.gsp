    ...
    <div class="body">
      ...
      <div class="dialog">
        <table id="myTable" class="tableview">
          <tbody>
            <tr class="prop odd">
              <td class="name"><g:message code="SLA.id.label" default="Id" /></td>
              <td class="value">${fieldValue(bean: SLAInstance, field: "id")}</td>
            </tr>
            <tr class="prop even">
              <td class="name"><g:message code="SLA.descricao.label" default="Descrição" /></td>
              <td class="value">${fieldValue(bean: SLAInstance, field: "descricao")}</td>
            </tr>
            <tr class="prop odd">
              <td class="name"><g:message code="SLA.tempo.label" default="Tempo" /></td>
              <td class="value">${fieldValue(bean: SLAInstance, field: "tempo")}</td>
            </tr>
          </tbody>
        </table>
      </div>
