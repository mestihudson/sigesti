      ...
      <g:form action="save" onsubmit="\$('[placeholder]').placeholder('clear');" >
        <div class="dialog">
          <p>
						...
						<g:textArea onkeydown="progresso_tecla(this.id)" onkeyup="progresso_tecla(this.id)" name="descricao" id="descricao" class="value ${hasErrors(bean: problemaInstance, field: 'descricao', 'errors')}" value="${problemaInstance?.descricao}" placeholder="descrição" />
