            ...
            <g:form action="save" onsubmit="\$('[placeholder]').placeholder('clear');" >
                <div class="dialog">
									<p>
										...
										<g:textField name="data_limite" id="data_limite" class="value ${hasErrors(bean: emprestimoInstance, field: 'data_limite', 'errors')}" value="${emprestimoInstance?.data_limite?.format('dd/MM/yyyy')}" placeholder="data limite de devolução" />
