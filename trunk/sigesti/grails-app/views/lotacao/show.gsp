		...
		<div class="body">
			...
			<div class="dialog">
				<table id="myTable" class="tableview">
					<tbody>
						<tr class="prop odd">
							<td class="name"><g:message code="lotacao.id.label" default="Id" /></td>
							<td class="value">${fieldValue(bean: lotacaoInstance, field: "id")}</td>
						</tr>
						<tr class="prop even">
							<td class="name"><g:message code="lotacao.nome.label" default="Nome" /></td>
							<td class="value">${fieldValue(bean: lotacaoInstance, field: "nome")}</td>
						</tr>
						<tr class="prop odd">
							<td class="name"><g:message code="lotacao.sigla.label" default="Sigla" /></td>
							<td class="value">${fieldValue(bean: lotacaoInstance, field: "sigla")}</td>
						</tr>
						<tr class="prop even">
							<td class="name"><g:message code="lotacao.telefone.label" default="Telefone" /></td>
							<td class="value">${fieldValue(bean: lotacaoInstance, field: "telefone")}</td>
						</tr>
					</tbody>
				</table>
			</div>
