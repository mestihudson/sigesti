	...
	<body>
		...
		<div class="body">
			...
			<g:form method="post" onsubmit="\$('[placeholder]').placeholder('clear');" >
				...
				<g:hiddenField name="version" value="${lotacaoInstance?.version}" />
				<div class="dialog">
					<p>
						<label for="nome"><g:message code="lotacao.nome.label" default="Nome" /></label>
						...
						<label for="sigla"><g:message code="lotacao.sigla.label" default="Sigla" /></label>
						...
						<label for="telefone"><g:message code="lotacao.telefone.label" default="Telefone" /></label>
